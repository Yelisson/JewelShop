namespace JewelShopService.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        elementtId = c.Int(nullable: false),
                        count = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.Elements", t => t.elementtId, cascadeDelete: true)
                .ForeignKey("dbo.Hangars", t => t.hangarId, cascadeDelete: true)
                .Index(t => t.hangarId)
                .Index(t => t.elementtId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HangarElements", "elementtId", "dbo.Elements");
            ...
            DropIndex("dbo.HangarElements", new[] { "elementtId" });
