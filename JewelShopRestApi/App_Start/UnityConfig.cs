...
namespace JewelShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AbstractDataBaseContext>(new HierarchicalLifetimeManager());
            container.RegisterType<IBuyerService, BuyerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IElementService, ElementServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<ICustomerService, CustomerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IAdornmentService, AdornmentServiceBD>(new HierarchicalLifetimeManager());
